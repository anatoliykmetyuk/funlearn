...
lazy val root = project.in(file(".")).aggregate(funlearnJVM, funlearnJS)
  .settings(commonSettings ++ Seq(
    publish := {},
    publishLocal := {},
  ))

lazy val funlearnJVM = project.in(file("jvm")).settings(commonSettings ++ Seq(
...
lazy val funlearnJS = project.in(file("js"))
